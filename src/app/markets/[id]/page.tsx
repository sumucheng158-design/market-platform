...
import {
  Calendar, MapPin, Clock, Users, ExternalLink, Heart,
  ...
  return (
    <div>
      <div className="relative h-[50vh] md:h-[60vh] overflow-hidden">
        <Image src={market.coverImage} alt={market.name} fill className="object-cover" priority />
        ...
        <div className="absolute bottom-0 left-0 right-0">
          <div className="container-base pb-8">
            <div className="flex items-center gap-2 mb-3">
              {mainCategory && (
                <span className="tag bg-white/20 text-white border border-white/20 backdrop-blur-sm">
                  {mainCategory.name}
                </span>
              )}
              {market.admissionFee === 0 && (
                <span className="tag bg-sage-300/80 text-sage-900 backdrop-blur-sm">免費入場</span>
              )}
            </div>
            <h1 className="font-display text-3xl md:text-5xl font-semibold text-white mb-2 drop-shadow-sm">
              {market.name}
            </h1>
            <p className="text-white/75 text-base">{market.tagline}</p>
          </div>
        </div>
      </div>
            ...
            <section>
              ...
              <div className="relative h-48 md:h-64 bg-cream-100 rounded-2xl overflow-hidden border border-cream-200 flex items-center justify-center">
                <div className="text-center">
                  <MapPin size={28} strokeWidth={1.6} className="text-latte-400 mx-auto mb-2" />
                  ...
                  >
                    在 Google Maps 開啟 <ExternalLink size={11} strokeWidth={2} />
                  </a>
                </div>
              </div>
            </section>
            ...
            <div className="card p-6 sticky top-20">
              ...
              <div className="space-y-4">
                <div className="flex gap-3">
                  <Calendar size={17} strokeWidth={1.8} className="text-latte-400 flex-shrink-0 mt-0.5" />
                  <div>
                ...
                <div className="flex gap-3">
                  <Clock size={17} strokeWidth={1.8} className="text-latte-400 flex-shrink-0 mt-0.5" />
                  <div>
                ...
                <div className="flex gap-3">
                  <MapPin size={17} strokeWidth={1.8} className="text-latte-400 flex-shrink-0 mt-0.5" />
                  <div>
                ...
                <div className="flex gap-3">
                  <Ticket size={17} strokeWidth={1.8} className="text-latte-400 flex-shrink-0 mt-0.5" />
                  <div>
                ...
                <div className="flex gap-3">
                  <Users size={17} strokeWidth={1.8} className="text-latte-400 flex-shrink-0 mt-0.5" />
                  <div className="flex-1">
                    ...
                    <div className="mt-2 h-2 bg-cream-200 rounded-full overflow-hidden">
                      <div className="h-full bg-latte-500 rounded-full" style={{ width: `${pct}%` }} />
                    </div>
              ...
              <div className="mt-6 space-y-3">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <button className="btn-secondary flex items-center justify-center gap-2 py-2.5">
                    <Heart size={14} strokeWidth={1.8} /> 收藏
                  </button>
                  <button className="btn-secondary flex items-center justify-center gap-2 py-2.5">
                    <Share2 size={14} strokeWidth={1.8} /> 分享
                  </button>
                </div>
              </div>
