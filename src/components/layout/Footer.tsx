    ...
    <footer className="bg-latte-900 text-cream-200 mt-20">
      <div className="container-base py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 md:gap-8">
          ...
          <div className="md:col-span-2">
            <div className="flex items-center gap-2 mb-4">
              <div className="w-8 h-8 bg-latte-600 rounded-lg flex items-center justify-center">
                <span className="text-cream-50 font-display text-sm font-semibold">市</span>
              </div>
              <span className="font-display text-lg font-semibold text-cream-100">市集平台</span>
            </div>
          ...
          {/* Links */}
          <div>
            <h4 className="text-sm font-semibold text-cream-100 mb-4 font-display">探索</h4>
          ...
          <div>
            <h4 className="text-sm font-semibold text-cream-100 mb-4 font-display">攤商</h4>
            <ul className="space-y-2">
              {[
        ...
        <div className="mt-12 pt-8 border-t border-latte-700 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-1 text-xs text-latte-500">
            <MapPin size={12} />
